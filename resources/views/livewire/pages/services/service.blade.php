...
<div>
    ...
    {{-- Our Services --}}
    <section class="lg:py-24 xl:py-36">
        <div class="container mx-auto lg:space-y-8 xl:space-y-12">
            <h1 class="font-semibold lg:text-xl xl:text-3xl lg:mb-12 xl:mb-24">Layanan yang Kami Sediakan</h1>
    ...
    {{-- Contact Us Service --}}
    <section class="lg:py-12 xl:py-24 bg-secondary">
        <div class="container flex flex-col items-center mx-auto text-center xl:space-y-12 lg:space-y-8">
            <h1 class="font-semibold xl:text-3xl lg:text-xl">Tidak Menemukan Solusi yang Sesuai Kebutuhan Anda?</h1>
            <p class="lg:text-sm xl:text-base">Tim kami siap memberikan bantuan dengan senang hati</p>
    ...
    {{-- Portfolio --}}
    <x-carousel carouselNum="2" bg="bg-secondary" class="text-center xl:space-y-24 lg:space-y-12 lg:py-12 xl:py-24">
    ...
    {{-- Technology --}}
    <section class="lg:py-24 xl:py-36">
        <div class="container flex mx-auto lg:gap-8 xl:gap-12">
            <div class="flex flex-col justify-center lg:w-3/4 xl:w-1/2 lg:gap-8 xl:gap-12">
                <h1 class="font-semibold lg:text-2xl xl:text-4xl">100+ <br> Teknologi yang Kami Gunakan</h1>
